<script lang="ts">
    const areas = [
        ...
        {
            name: 'Personal Growth/Education',
...
<article class="prose max-w-full">
    ...
    <section>
        ...
        <p>Below are some examples of the most common areas of life people choose from. Most people usually pick between 4 to 8 areas of life.</p>
